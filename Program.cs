...
namespace ClientServerCSharp
{
    class Program
    {
        ...
        {
            Console.WriteLine("Pi calculation programm");
        }
                    ...
                    if (commands.Length > 0)
                    {
                        switch (commands[0])
                        {
                            case "i":
                                ...
                                Console.WriteLine("ss - show/set settings; full format {c -ip hostIp -p hostPort -s steps -c maxCalcClients}");
                                ...
                                Console.WriteLine("sc - start calculations");
                                break;
                            ...
                            case "sc":
                                Console.WriteLine(Server.DoCalculations().ToString());
                                break;
